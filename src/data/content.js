...
export const projectsDetailed = [
  ...
  },
  {
    ...
    image: '/projects/mantto-puebla-2024-1.jpg',
  ...
  {
    title: 'Instalación 3 Salas — Puebla',
    category: 'Justicia Digital',
    description: 'Diseño e instalación de 3 nuevas salas de audiencia oral equipadas con sistemas de audio, video y grabación de última generación.',
    image: '/projects/instalacion-salas-2.jpg',
    specs: ['3 Salas Nuevas', 'Audio DSP', 'Cámaras PTZ', 'MASOD®'],
    year: 2025,
  },
  {
    title: 'Mantenimiento Pachuca 2024',
    category: 'Mantenimiento',
    description: 'Servicio de mantenimiento preventivo y correctivo a las salas de oralidad del Poder Judicial de Pachuca, Hidalgo.',
    image: '/projects/mantto-pachuca-1.jpg',
    specs: ['Mantenimiento Preventivo', 'Calibración Audio', 'Limpieza Óptica', 'Firmware Update'],
    year: 2024,
  },
  {
    title: 'Mantenimiento Puebla 2024',
    category: 'Mantenimiento',
    description: 'Mantenimiento integral de salas en Puebla Centro, Tehuacán, Tepeaca y Cd. Serdán con servicio en más de 16 salas simultáneas.',
    image: '/projects/mantto-puebla-2024-2.jpg',
    specs: ['16+ Salas', 'Puebla Centro', 'Tehuacán', 'Cd. Serdán'],
    year: 2024,
  },
  {
    title: 'Mantenimiento Puebla 2026',
    category: 'Mantenimiento',
    description: 'Servicio de mantenimiento de nueva generación con actualización de firmware MASOD® y calibración de sistemas de audio y video.',
    image: '/projects/mantto-puebla-2026-1.jpg',
